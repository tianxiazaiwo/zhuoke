cordova.define("jp.wizcorp.phonegap.plugin.wizSpinnerPlugin.wizSpinnerPlugin", function(require, exports, module) { /* Spinner/Loader Cordova Plugin - JavaScript side of the bridge to iOS
 *
 * @author Ally Ogilvie
